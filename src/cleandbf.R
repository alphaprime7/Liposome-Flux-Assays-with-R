...
#Write dbf files to csv files for tidying in excel.
...
#Read transposed cleaned csv files into R for normalization
...
#0 seconds seems to distort data visualization
...
#min-max normalization drops an attribute
...
#write normalized data to csv for more cleanup
...
abline(p1, col="blue")
p2 = plot(E04 ~ WELLNUM, data=navablfacsv_norm,
          pch=16,
          col="dodgerblue1",
          main = "NavAb Liposome Flux Assay",
          xlab = "Cycle Number",
