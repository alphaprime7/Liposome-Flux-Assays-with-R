...
legend("topright", inset = c(-0.4, 0), legend=c("Exp", "NC","PC"), 
       title = "20 uM ACMA", title.col = "purple", box.col = "black", box.lwd = 0, col=c("blue","red","green"), lty = 1:3, lwd = 3, cex=0.7, xpd = T)
#NEXT PLOT 221
...
legend("topright", inset = c(-0.3, 0), legend=c("Test", "NC","PC"), 
       title = "2uM ACMA", title.col = "purple", box.lwd = 1, box.col = "orange", col=c(3,4,"red"), lty = 1:2, lwd = 3, cex=0.7, xpd = T)
# X-axis
xlim = c(min, max)
axis(1, at = c(60,600))
